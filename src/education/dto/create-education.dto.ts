...
export class CreateEducationDto {
  ...
  @ApiPropertyOptional({
    ...
    example:
      'A comprehensive overview of the historical events leading to the 1994 genocide against the Tutsi in Rwanda',
    maxLength: 1000,
  })
  @IsOptional()
  @IsString()
  ...
  @ValidateIf(
    (o) => o.type === ContentType.VIDEO || o.type === ContentType.AUDIO,
  )
  @IsNumber()
  @Min(1)
  @Max(1440)
